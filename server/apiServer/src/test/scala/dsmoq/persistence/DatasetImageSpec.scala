...
class DatasetImageSpec extends Specification {
  ...
  "DatasetImage" should {
    ...
    "create new record" in new AutoRollback {
      val created = DatasetImage.create(id = null, datasetId = null, imageId = null, isPrimary = false, isFeatured = false, createdBy = null, createdAt = DateTime.now, updatedBy = null, updatedAt = DateTime.now)
