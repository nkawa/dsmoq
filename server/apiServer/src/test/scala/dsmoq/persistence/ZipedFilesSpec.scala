...
class ZipedFilesSpec extends Specification {
  ...
  "ZipedFiles" should {
    ...
    "create new record" in new AutoRollback {
      val created = ZipedFiles.create(id = null, historyId = null, name = "MyString", description = "MyString", fileSize = 1L, createdBy = null, createdAt = DateTime.now, updatedBy = null, updatedAt = DateTime.now, dataStart = 1L, dataSize = 1L, cenSize = 1L, cenHeader = Array())
