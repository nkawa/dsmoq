...
class GroupImageSpec extends Specification {
  ...
  "GroupImage" should {
    ...
    "create new record" in new AutoRollback {
      val created = GroupImage.create(id = null, groupId = null, imageId = null, isPrimary = 123, displayOrder = 123, createdBy = null, createdAt = DateTime.now, updatedBy = null, updatedAt = DateTime.now)
