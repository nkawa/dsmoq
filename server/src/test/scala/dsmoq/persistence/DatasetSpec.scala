...
class DatasetSpec extends Specification {
  ...
  "Dataset" should {
    ...
    "create new record" in new AutoRollback {
      val created = Dataset.create(id = null, name = "MyString", description = "MyString", licenseId = null, filesCount = 123, filesSize = 1L, createdBy = null, createdAt = DateTime.now, updatedBy = null, updatedAt = DateTime.now)
