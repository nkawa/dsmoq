...
class ZipedFilesSpec extends Specification {
  ...
  "ZipedFiles" should {
    ...
    "create new record" in new AutoRollback {
      val created = ZipedFiles.create(id = null, fileId = null, name = "MyString", description = "MyString", fileSize = 1L, createdBy = null, createdAt = DateTime.now, updatedBy = null, updatedAt = DateTime.now)
